...
export default function PayFastDebug() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 space-y-6">
      <div>
        <Link to="/courses" className="text-burnt-600 text-sm hover:underline">
          ← Back to courses
        </Link>
        <h1 className="text-3xl font-black mt-4 bg-gradient-to-r from-burnt-400 to-primary-400 bg-clip-text text-transparent">
          PayFast debug
        </h1>
