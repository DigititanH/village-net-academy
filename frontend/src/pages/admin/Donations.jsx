...
export default function AdminDonations() {
  ...
  const downloadReport = (format) => {
    ...
    fetch(`${API_BASE}/admin/reports/donations/${format}`, { headers: { Authorization: `Bearer ${token}` } })
      .then((r) => r.blob())
      .then((blob) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-black bg-gradient-to-r from-burnt-400 to-primary-400 bg-clip-text text-transparent">Donations</h1>
