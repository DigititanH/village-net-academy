...
import { Users, DollarSign, ShoppingBag, Package, UserCheck } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-black bg-gradient-to-r from-burnt-400 to-primary-400 bg-clip-text text-transparent">Dashboard Overview</h1>
