    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-3xl font-black mb-3">
          {isDonation ? "Donation Not Completed" : isCcna ? "CCNA Payment Cancelled" : "Payment Cancelled"}
        </h1>
        <p className="text-gray-400 mb-2">
          {isDonation
            ? "You left PayFast before completing your donation. No payment was taken."
            : isCcna
              ? "You left PayFast before starting the CCNA subscription. No payment was taken — you can try again anytime."
              : "You left PayFast before completing payment. Your order is still pending and your cart items are saved."}
        </p>
        {id && (
          <p className="text-sm text-gray-500 mb-8">
            Reference: {isDonation ? "Donation" : isCcna ? "Enrolment" : "Order"} #{id}
          </p>
        )}
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          {isDonation ? (
            ...
            <>
              <Link to="/courses/enrol" className="btn-primary">Try Again</Link>
