...
export default function Donation() {
  ...
  const handlePayment = async () => {
    ...
    if (payfastEnabled && Number(amount) < 5) {
      return toast.error("PayFast donations must be at least R5.00");
    }
    ...
    try {
      ...
      if (payfastEnabled) {
        toast.error("PayFast did not return payment details. Check server PayFast settings.");
        return;
      }
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center px-4">
        <div className="text-center max-w-md card">
          ...
          <h1 className="text-3xl font-black mb-3 bg-gradient-to-r from-burnt-400 to-primary-400 bg-clip-text text-transparent">Thank You!</h1>
  ...
  return (
    <div>
      <PageHero
        image={pageHeroImages.donation}
        alt="Support Village NetAcad learners"
        title="Power The Future"
        subtitle="Every rand you donate helps us bring digital education to another village learner."
      />
      ...
      <section className="section-padding">
        <div className="max-w-xl mx-auto">
          ...
          >
            <h2 className="text-2xl font-black bg-gradient-to-r from-burnt-400 to-primary-400 bg-clip-text text-transparent">Make a Donation</h2>
                ...
                {presets.map((p) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-sm font-bold border transition-all duration-300 ${
                      String(p) === amount
                        ? "bg-gradient-to-r from-burnt-400 to-primary-400 text-white border-transparent shadow-[0_0_20px_rgba(14,165,233,0.28)]"
