...
export default function Career() {
  return (
    <div>
      <PageHero
        image={pageHeroImages.career}
        alt="Join the Village NetAcad team"
        eyebrow="Join Our Mission"
        title="Careers"
        subtitle="Help us empower communities through digital skills training, innovation programmes, and inclusive growth."
      />
      ...
      <section className="section-padding">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-center mb-10 bg-gradient-to-r from-burnt-400 to-primary-400 bg-clip-text text-transparent">
            Open Opportunities
          </h2>
