  ...
  return (
    <div className="section-padding">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-black mb-8 bg-gradient-to-r from-burnt-400 to-primary-400 bg-clip-text text-transparent">Checkout</h1>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button type="submit" disabled={loading} className="btn-primary w-full text-lg flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
