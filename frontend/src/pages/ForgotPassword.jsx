      ...
      <div className="card w-full max-w-md text-center">
        {sent ? (
          <>
            ...
            <h1 className="text-2xl font-black mb-2 bg-gradient-to-r from-burnt-400 to-primary-400 bg-clip-text text-transparent">Check Your Email</h1>
          ...
          <>
            ...
            <h1 className="text-2xl font-black mb-1 bg-gradient-to-r from-burnt-400 to-primary-400 bg-clip-text text-transparent">Forgot Password?</h1>
